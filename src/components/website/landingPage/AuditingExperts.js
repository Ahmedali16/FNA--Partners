...
export default function AuditingExperts() {
          ...
          <Grid container alignItems="center" spacing={4}>
            <Grid item size={{xs:12,md:6}}>
              <Typography
                ...
                data-aos-delay="100"
              >
                Premier Accounting & Auditing<br />
                Experts in UAE & Saudi Arabia
              </Typography>
              ...
              <Typography
                ...
                data-aos-delay="200"
              >
                Welcome to FNA Partners, your trusted partner for professional accounting services in UAE & Saudi Arabia. With years of expertise in financial management, compliance, and business advisory, we help businesses of all sizes streamline their finances, minimize risks, and maximize growth.
              </Typography>
              ...
              <Typography
                ...
                data-aos-delay="300"
              >
                Whether you need bookkeeping, tax filing, payroll services, or VAT compliance, our certified accountants ensure accuracy, efficiency, and full regulatory adherence.
              </Typography>
            ...
            <Grid item size={{xs:12,md:6}}>
              ...
              <Box data-aos="fade-up" data-aos-delay="500" display={"flex"} justifyContent={"center"}>
                <Image
                  src="/images/PremierAccounting.png"
                  width={800}
                  height={800}
                  alt="Top image"
                  style={{
